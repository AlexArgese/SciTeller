      ...
      <section className={styles.credits}>
        ...
        <div className={styles.personBlock}>
          ...
          <p className={styles.personText}>
            Internship project: <em>AI Scientist Storyteller (SciTeller)</em>.
            Responsible for dataset construction, Splitter–Storyteller design,
            fine-tuning of Qwen2.5–7B / Qwen2.5–32B, and full system development
            (web platform, backend APIs, and GPU-serving infrastructure).
          </p>
          <ul className={styles.linkList}>
            <li>
              <a
                href="mailto:argese@eurecom.fr"
                target="_blank"
                rel="noreferrer"
              >
                Email
            ...
            <li>
              <a
                href="https://github.com/AlexArgese/ai-scientist-storyteller"
                target="_blank"
                rel="noreferrer"
              >
                Project Repository
        ...
        <div className={styles.supervisors}>
          ...
          <ul className={styles.supList}>
            <li>
              ...
              <p>Associate Professor in the Data Science Department at EURECOM</p>
              <ul className={styles.linkList}>
                <li style={{ border: 0 }}>
                  <a
            ...
            <li>
              <div className={styles.supName}>
                Prof. Luigi De Russis (Politecnico di Torino)
              </div>
              <p>
                Vice Head of the Department of Control and Computer Engineering
                and Associate Professor at Politecnico di Torino
              </p>
              <ul className={styles.linkList}>
                <li style={{ border: 0 }}>
                  <a
